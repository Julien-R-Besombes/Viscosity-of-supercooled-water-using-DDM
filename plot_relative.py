...
ax1.scatter(temperature, viscosity*1e3, label='Valeurs 02/18, 512px, corrigées, a non fixée', marker='+', color='g')
ax1.scatter(temperature_raw, viscosity_raw*1e3, label='Valeurs 02/18, 512px, non corrigées, a non fixée', marker='+', color='b')
